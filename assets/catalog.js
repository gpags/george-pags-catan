...
/* ================================================================
   ...
   footer line disappears by itself when all 20 are done.
...
const PRODUCTS = [
  ...
  {id:2, h:'just-a-fat-cat',       t:'Just A Fat Cat',       v:'chonky',  size:'M', price:26, sales:71,  new:0, badge:'', colorsAvailable:ALL9, img:'US1958705a9b055b/design/7f6591f6a3701033.png',        desc:'No pose, no gimmick, just a very large cat. Smooth surfaces, no visible layer lines on the belly.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  {id:3, h:'sleepy-chonk',         t:'Sleepy Chonk',         v:'chonky',  size:'M', price:26, sales:84,  new:0, badge:'', colorsAvailable:ALL9, img:'US423f6abd75703/design/76fc93bdb5a4970c.jpeg',        desc:'Curled, paws tucked, fully asleep. The one people pick up and refuse to put down.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  ...
  {id:5, h:'yawning-chibi-cat',    t:'Yawning Chibi Cat',    v:'chibi',   size:'M', price:22, sales:77,  new:1, badge:'new', colorsAvailable:ALL9, img:'USa8052536c37dcd/design/2025-09-10_b13d6265afd3c.png',  desc:'Caught mid-yawn with its jaw wide open. Reads instantly from across a room.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  {id:6, h:'stretching-chibi-cat', t:'Stretching Chibi Cat', v:'chibi',   size:'M', price:26, sales:62,  new:1, badge:'', colorsAvailable:ALL9, img:'USbfedd9c3c494fc/design/2025-09-05_ab666ee339217.png',  desc:'Front paws forward, back arched. A long, low silhouette that suits a shelf edge.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  {id:7, h:'flexi-cat-keychain',   t:'Flexi Cat Keychain',   v:'flexi',   size:'S', price:12, sales:120, new:0, badge:'bogo', colorsAvailable:ALL9, img:'US6b941ba8302236/design/2c7d72fa7a1a4499.png',        desc:'Articulated spine, printed in one piece. Clips to a bag and wiggles the whole way there.', /*TODO*/ weightOz:2, boxClass:'poly-S', stock:40, photoReal:false},
  {id:8, h:'eggo-flexi-cat',       t:'EGGO Flexi Cat',       v:'flexi',   size:'M', price:18, sales:66,  new:1, badge:'new', colorsAvailable:ALL9, img:'USc93f92f737d9f9/design/7a063b158d3ec0d1.jpg',        desc:'A chunkier flexi with deeper segments. More satisfying in the hand, still pocket sized.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  {id:9, h:'flexi-cat-toy',        t:'Flexi Cat Toy',        v:'flexi',   size:'S', price:16, sales:54,  new:0, badge:'', colorsAvailable:ALL9, img:'US87ee968d70c396/design/854ab97a1aaa6e15.jpg',        desc:'The desk-sized flexi. Big enough to fidget with properly, no keyring loop.', /*TODO*/ weightOz:2, boxClass:'poly-S', stock:0, photoReal:false},
  ...
  {id:14,h:'cat-mage',             t:'Cat Mage',             v:'witchy',  size:'L', price:32, sales:41,  new:1, badge:'new', colorsAvailable:ALL9, img:'USb8026e4b9070a5/design/928c0adb2e327397.png',        desc:'Staff, hat, and a deeply unimpressed expression. Scales to 28mm for the tabletop.', /*TODO*/ weightOz:9, boxClass:'box-L', stock:12, photoReal:false},
  {id:15,h:'cat-on-the-moon',      t:'Cat On The Moon',      v:'witchy',  size:'L', price:34, sales:69,  new:0, badge:'', colorsAvailable:ALL9, img:'US416f1196034dc/design/2025-07-04_0adc6d211b9ea8.jpg',  desc:'Perched on a crescent, 140mm tall. Our biggest piece and the best gift in the range.', /*TODO*/ weightOz:12,boxClass:'box-L', stock:12, photoReal:false},
  {id:16,h:'monitor-buddy',        t:'Monitor Buddy',        v:'chibi',   size:'M', price:18, sales:95,  new:1, badge:'best', colorsAvailable:ALL9, img:'US92596077edfe56/design/bf532d11dd01e816.png',        desc:'Weighted paws hook over the top edge of a screen. Fits monitors and laptops up to 12mm.', /*TODO*/ weightOz:5, boxClass:'box-M', stock:25, photoReal:false},
  ...
  {id:19,h:'cat-paw-keychain',     t:'Cat Paw Keychain',     v:'flexi',   size:'S', price:10, sales:110, new:0, badge:'bogo', colorsAvailable:ALL9, img:'US3844e8ad64d1c5/design/2025-03-30_9b5f916808dd7.jpg', desc:'A clicky paw with a satisfying snap. Optional recess inside for an NFC tag.', /*TODO*/ weightOz:1, boxClass:'poly-S', stock:40, photoReal:false},
  {id:20,h:'cat-clicker',          t:'Cat Clicker',          v:'chonky',  size:'S', price:15, sales:102, new:1, badge:'best', colorsAvailable:ALL9, img:'US13c90689edb9dd/design/7c22f4c81f77549b.png',        desc:'Press the belly. That is the whole product, and it is extremely hard to stop doing.', /*TODO*/ weightOz:2, boxClass:'poly-S', stock:40, photoReal:false}
];
