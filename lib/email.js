...
//   SHOP_EMAIL          where order alerts and form messages land (realizedprints@gmail.com)
//   EMAIL_FROM          verified sender, e.g. "Cat Scratchers <hello@mycatscratcher.com>"
...
const EMAIL_FROM = process.env.EMAIL_FROM || 'Cat Scratchers <onboarding@resend.dev>';
